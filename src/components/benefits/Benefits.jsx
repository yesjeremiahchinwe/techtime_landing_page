...
const Benefits = () => {
    ...
    return (
        <section className='min-h-screen w-full min-w-[375px] bg-[#F8F9FC] px-6 md:px-8 xl:px-0 py-16 relative'>
            ...
            <article className="xl:w-[85%] mx-auto py-12 md:py-10 grid grid-cols-1 xl:grid-cols-2 gap-20 items-center">
                <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-[#ffffff] px-6 py-8 rounded-md">
