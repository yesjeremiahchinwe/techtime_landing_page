...
const Features = () => {
  return (
    <section className='min-h-screen w-full min-w-[375px] bg-[#F8F9FC] px-6 md:px-8 xl:px-0 pt-12 relative'>
      ...
      <article className="relative xl:w-[85%] mx-auto pt-20 grid grid-cols-1 xl:grid-cols-2 gap-x-8 gap-y-12 items-center">
        ...
        <div>
          <h2 className='font-[700] text-[56px] leading-[70px] text-center md:text-start relative'><img src={halfStar} alt="Half star" className="absolute left-0 -top-8 xl:-left-8 md:-left-8" />High quality video, audio & live classes</h2>
          ...
          <button className='bg-[#004DB3] font-[700] text-[16px] leading-[21.6px] text-[#ffffff] py-4 px-6 block mx-auto md:mx-0 hover:text-[#004DB3] hover:bg-[#ffffff] border-solid border-4 border-[#004DB3]'>View Courses</button>

          <div className="flex items-center gap-5 pt-8 justify-center md:justify-start">
            <div className="bg-[#ffffff] w-fit px-4 py-4 flex gap-4 items-center rounded-md">
