...
const Features = () => {
  return (
    <section className='min-h-screen w-full min-w-[300px] mx-auto bg-[#F8F9FC] pt-12 px-8 relative'>
      ...
      <article className="relative lg:w-[90%] mx-auto pt-8 grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-12 items-center">
        <img src={greenW} alt="Green Skew lines" className="absolute right-0 top-12 xl:-right-[7rem] hidden xl:block" />
        ...
        <div>
          ...
          <button className='bg-[#004DB3] font-[700] text-[16px] leading-[21.6px] text-[#ffffff] w-fit py-4 px-6 block mx-auto md:mx-0 hover:text-[#004DB3] hover:bg-[#ffffff] border-solid border-4 rounded-lg border-[#004DB3] shadow-xl'>View Courses</button>
            ...
            <div className="flex justify-start items-center w-full flex-wrap gap-4 pt-4 lg:no-wrap">
