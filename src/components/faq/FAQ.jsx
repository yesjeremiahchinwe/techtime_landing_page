            ...
            <article className='w-full py-8 md:max-w-[80%] mx-auto'>
                ...
                <div className="max-w-[900px] mx-auto py-2 wrapper">
                    ...
                    <div className="border-b-[1px] border-solid border-[#EAEAEA] py-6 flex flex-col justify-center">
                        <h3 className={`flex justify-between gap-8 items-center font-[900] text-[24px] leading-[32.4px] py-2 cursor-pointer text-[#000F24] ${isSecond ? "text-[#004DB3]" : ""}`} onClick={() => setIsSecond(!isSecond)}>Can I change my plan later? <img src={isSecond ? minusIcon : addIcon} alt="Plus Sign" /></h3>
                    ...
                    <div className="border-b-[1px] border-solid border-[#EAEAEA] py-6 flex flex-col justify-center">
                        <h3 className={`flex justify-between gap-8 items-center font-[900] text-[24px] leading-[32.4px] py-2 cursor-pointer text-[#000F24] ${isThird ? "text-[#004DB3]" : ""}`} onClick={() => setIsThird(!isThird)}>Are the courses lifetime? <img src={isThird ? minusIcon : addIcon} alt="Plus Sign" /></h3>
                    ...
                    <div className="border-b-[1px] border-solid border-[#EAEAEA] py-6 flex flex-col justify-center">
                        <h3 className={`flex justify-between gap-8 items-center font-[900] text-[24px] leading-[32.4px] py-2 cursor-pointer text-[#000F24] ${isFourth ? "text-[#004DB3]" : ""}`} onClick={() => setIsFourth(!isFourth)}>Do I get certified after taking courses? <img src={isFourth ? minusIcon : addIcon} alt="Plus Sign" /></h3>
                    ...
                    <div className="border-b-[1px] border-solid border-[#EAEAEA] py-6 flex flex-col justify-center">
                        <h3 className={`flex justify-between gap-8 items-center font-[900] text-[24px] leading-[32.4px] py-2 cursor-pointer text-[#000F24] ${isFiveth ? "text-[#004DB3]" : ""}`} onClick={() => setIsFiveth(!isFiveth)}>How do I reach out to mentors? <img src={isFiveth ? minusIcon : addIcon} alt="Plus Sign" /></h3>
                    ...
                    <div className="border-b-[1px] border-solid border-[#EAEAEA] py-6 flex flex-col justify-center">
                        <h3 className={`flex justify-between gap-8 items-center font-[900] text-[24px] leading-[32.4px] py-2 cursor-pointer text-[#000F24] ${isSixth ? "text-[#004DB3]" : ""}`} onClick={() => setIsSixth(!isSixth)}>Do we get job ready after taking courses? <img src={isSixth ? minusIcon : addIcon} alt="Plus Sign" /></h3>
