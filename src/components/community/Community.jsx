  ...
  return (
    <section className='w-full min-w-[300px] mx-auto mni-h-screen bg-[#004DB3] text-[#ffffff] px-4 md:px-8'>
        <article className='py-12 md:max-w-[70%] md:mx-auto'>
            ...
            <h2 className='font-[700] text-2xl md:text-[56px] leading-[35px] md:leading-[68.88px] text-center py-6'>Are you  ready to connect with the future talent of the tech world</h2>
